 ...
 * falls back to writing generatedDir on local disk (the docker-compose
 * setup, where nginx serves that directory from a shared volume).
 *
 ...
 * public bucket instead and manager.generatedUrl points at it.
 *
 ...
 * holding a key scoped to the generated-files bucket ONLY — the manager
 * must never carry broader credentials.
 */
